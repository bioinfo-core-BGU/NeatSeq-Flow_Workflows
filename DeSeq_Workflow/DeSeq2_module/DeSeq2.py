...
class Step_DeSeq2(Step):
    ...
    def build_scripts(self):
        ...
        if self.params["script_path"]==None: 
            if "DeSeq2_module.R" in os.listdir(self.module_location): 
                self.params["script_path"]= "Rscript  %s "  % os.path.join(self.module_location,"DeSeq2_module.R")
            else:
